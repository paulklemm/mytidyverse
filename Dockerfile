...
RUN Rscript -e 'install.packages(c("devtools", "tidyverse", "roxygen2", "ggrepel", "renv", "usethis", "WriteXLS", "plotly", "svglite", "languageserver", "flexdashboard", "DT", "rJava", "Seurat", "styler", "knitr", "rmarkdown", "vroom", "tidylog"), repos = "http://cloud.r-project.org/"); BiocManager::install(c("biomaRt", "clusterProfiler", "DESeq2"), upate=FALSE, ask = FALSE); devtools::install_github("rstudio/distill"); remotes::install_github("yihui/xaringan"); devtools::install_github("paulklemm/mygo"); devtools::install_github("paulklemm/rmyknife"); devtools::install_github("paulklemm/peekr"); devtools::install_github("paulklemm/rvisidata");'
